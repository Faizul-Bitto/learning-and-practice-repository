                    ...
                    <div class="transition hover:bg-indigo-50">
                        ...
                        <div class="px-5 pt-0 text-left pb-5" v-show="accordionIndex == 0">
                            <p class="leading-6 font-light pl-9 ">
                                ...
                                saepe quibusdam
                                iusto possimus nesciunt dolores assumenda quae totam, doloremque odit. Itaque cum animi,
                                labore debitis
                                deserunt iusto!
                            </p>
                        </div>
                    ...
                    <div class="transition hover:bg-indigo-50">
                        ...
                        <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordionIndex == 1">
                            <p class="leading-6 font-light pl-9 ">
                                ...
                                incidunt ab sit
                                optio debitis dignissimos doloribus ratione nobis id mollitia maiores eveniet
                    ...
                    <div class="transition hover:bg-indigo-50">
                        ...
                        <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordionIndex == 3">
                            <p class="leading-6 font-light pl-9">
                                ...
                                dolore qui
                                architecto pariatur incidunt repellat quos hic? Eius, eveniet accusantium! Quisquam,
                                quo. Vitae ipsum ad
