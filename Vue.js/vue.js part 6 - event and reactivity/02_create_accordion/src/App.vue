            ...
            <div class="w-3/4 mx-auto rounded border">
                <div class="bg-white p-10 shadow-sm">
                    ...
                    <p class="text-sm font-light text-gray-600 my-3">
                        The accordion is a graphical control element comprising a vertically stacked list of items such
                        as labels or thumbnails
                    </p>
                    ...
                    <div class="transition hover:bg-indigo-50">
                        ...
                        <div class="px-5 pt-0 text-left pb-5" v-show="accordions[0]">
                            <p class="leading-6 font-light pl-9 ">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi dolor dolorum odio,
                                saepe quibusdam iusto possimus nesciunt dolores assumenda quae totam, doloremque odit.
                                Itaque cum animi, labore debitis deserunt iusto!
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="transition hover:bg-indigo-50">
                        <!-- header -->
                        <div @click="accordions[1] = !accordions[1]"
                            class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16">
                            <i class="fas fa-plus"></i>
                        ...
                        <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordions[1]">
                            <p class="leading-6 font-light pl-9 ">
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut suscipit itaque, sequi
                                incidunt ab sit optio debitis dignissimos doloribus ratione nobis id mollitia maiores
                    ...
                    <div class="transition hover:bg-indigo-50">
                        ...
                        <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordions[2]">
                            <p class="leading-6 font-light pl-9">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima facilis labore
                                voluptates provident nam, delectus suscipit nihil optio voluptate quae porro fugiat
                                magni excepturi doloribus.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="transition hover:bg-indigo-50">
                        ...
                        <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordions[3]">
                            <p class="leading-6 font-light pl-9">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam minima maiores magni
                                dolore qui architecto pariatur incidunt repellat quos hic? Eius, eveniet accusantium!
                                Quisquam, quo. Vitae ipsum ad veritatis commodi quasi expedita!
                            </p>
                        </div>
                    </div>
                </div>
