            ...
            <div class="py-12 w-full">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                        <div class="flex p-2">
                            <a href="{{ route('SuperAdmin.ManageUsers.index') }}"
                                ...
                                @if ($user->roles)
                                    @foreach ($user->roles as $user_role)
                                        <form class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md"
                                            method="POST"
                                            action="{{ route('SuperAdmin.ManageUsers.roles.remove', [$user->id, $user_role->id]) }}"
                        ...
                        <div class="max-w-xl mt-6">
                            <form method="POST" action="{{ route('SuperAdmin.ManageUsers.roles', $user->id) }}">
                                @csrf
                            ...
                            @if ($user->roles)
                                @foreach ($user->roles as $user_role)
                                    <div class="flex flex-col">
                                        <div class="font-semibold">{{ $user_role->name }} Permissions:</div>
