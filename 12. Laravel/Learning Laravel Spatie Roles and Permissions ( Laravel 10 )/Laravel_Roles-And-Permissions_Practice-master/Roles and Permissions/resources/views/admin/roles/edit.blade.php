        ...
        <div class="py-12 w-full">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                    <div class="flex p-2">
                        <a href="{{ route('SuperAdmin.ManagePermissions.index') }}"
                            class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">Permission
                            Index</a>
                    </div>
                    <div class="flex flex-col p-2 bg-slate-100">
                        <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                            <form action="{{ route('SuperAdmin.ManageRoles.update', $role) }}" method="POST">
                                @csrf
                                @method('PUT')
                    ...
                    <div class="mt-6 p-2 bg-slate-100">
                            ...
                            @if ($role->permissions)
                                @foreach ($role->permissions as $role_permission)
                                    <form class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md"
                                        method="POST"
                                        action="{{ route('SuperAdmin.ManageRoles.permissions.revoke', [$role->id, $role_permission->id]) }}"
                        ...
                        <div class="max-w-xl mt-6">
                            <form action="{{ route('SuperAdmin.ManageRoles.permissions.add', $role) }}" method="POST">
                                @csrf
                                <div class="sm:col-span-6">
